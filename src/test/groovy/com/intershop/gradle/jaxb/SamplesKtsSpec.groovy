        ...
        buildFile << """
            ...
            jaxb {
                javaGen {
                    register("test") {
                        catalog = file("catalog.cat")
                        schemas = fileTree("dir" to ".", "includes" to listOf("ipo.xsd","ustaxexemptpo.xsd"))
                    }
                }
            }
            ...
            jaxb {
                javaGen {
                    register("test") {
                        ...
                        schemas = fileTree("dir" to "cd-UBL-1.0/xsd", "include" to "**/*.xsd")
                    }
                }
            }
        ...
        buildFile << """
            ...
            jaxb {
                schemaGen {
                    register("test") {
                        inputDir = file("src")
                        excludes = listOf( "Main.java", "shoppingCart/AdapterPurchaseListToHashMap.java" )
                    }
                }
            }
